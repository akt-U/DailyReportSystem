...
INSERT INTO report(report_date, title, content, employee_id, created_at, updated_at) VALUES (CURRENT_TIMESTAMP, "aaa", "aaa", 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO report(report_date, title, content, employee_id, created_at, updated_at) VALUES (CURRENT_TIMESTAMP, "aaa", "aaa", 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO report(report_date, title, content, employee_id, created_at, updated_at) VALUES (CURRENT_TIMESTAMP, "aaa", "aaa", 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);